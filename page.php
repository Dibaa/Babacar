...
<html>
<head>
<title>Boussole Electorale</title>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					 <li class="active"><a href="index.html">Home</a></li>
						<li><a href="sports.html">Actualités</a></li>
				    <li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown">Canditats<b class="caret"></b></a>
						<ul class="dropdown-menu">
							<li><a href="entertainment.html">Evenelent</a></li>
							<li class="divider"></li>
					...
					<div class="callbacks_wrap">
						<ul class="rslides" id="slider">
							<li>
								...
								<div class="caption">
									<a href="single.html">Plus rien ne vous échappe de vos condidats pour faire le bon Choix</a>
								</div>
							</li>
							<li>
								<img src="images/2.jpg" alt="" style="height: 30%">
								<div class="caption">
